namespace Gamee.Hiuk.Pattern 
{
	...
	public class PoolManager : Singleton<PoolManager>
	{
		...
		public void releaseObjectAll()
		{
			for (int i = 0; i < root.childCount; i++)
			{
				releaseObject(root.GetChild(i).gameObject);
			}
		}
		...
		public static Transform Root => Instance.root;
		...
		public static void ReleaseObjectAll()
		{
			Instance.releaseObjectAll();
		}
		#endregion
	}
}
